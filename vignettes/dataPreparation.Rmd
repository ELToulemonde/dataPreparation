...
Based on  [data.table](https://rdatatable.gitlab.io/data.table/) package, **dataPreparation** will allow you to do most of the painful data preparation for a data science project with a minimum amount of code.
