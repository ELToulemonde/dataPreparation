...
- Integration:
  - Rewrite all *whichFunction.R*, *aggregate.R*, *numericsManuipulations.R*, *sameShape.R* tests to make them more readable
  - Rewrite some of *generericFunctions.R* tests to make them more readable
